...
const HeroSection = () => {
  return (
    <section className="relative bg-mw-green/5 py-24 text-center overflow-hidden">
    ...
    <div className="container mx-auto px-4 relative">
      <h1 className="text-5xl lg:text-6xl font-serif font-bold text-mw-green">Blissful World & Peace Movement</h1>
      <p className="mt-4 text-lg max-w-3xl mx-auto text-mw-green/90 font-sans">
        Transforming society through inner bliss and collective coherence.
      </p>
    </div>
  </section>
  )
